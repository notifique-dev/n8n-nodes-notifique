...
export class NotifiqueNode implements INodeType {
  description: INodeTypeDescription = {
    ...
    properties: [
      ...
      { displayName: 'Tag ID', name: 'tagId', type: 'string', default: '', displayOptions: { show: { resource: ['tags'], operation: ['get', 'update', 'delete'] } } },
      { displayName: 'Tag Name', name: 'tagName', type: 'string', default: '', displayOptions: { show: { resource: ['tags'], operation: ['create', 'update'] } } },
      ...
      { displayName: 'App ID', name: 'appId', type: 'string', default: '', displayOptions: { show: { resource: ['pushApps'], operation: ['get', 'update', 'delete'] } } },
      { displayName: 'App Name', name: 'appName', type: 'string', default: '', displayOptions: { show: { resource: ['pushApps'], operation: ['create', 'update'] } } },
      {
      ...
      { displayName: 'Device ID', name: 'deviceId', type: 'string', default: '', displayOptions: { show: { resource: ['pushDevices'], operation: ['get', 'delete'] } } },
      {
        displayName: 'Register Payload (JSON)',
      ...
      {
        displayName: 'Push Payload (JSON)',
        name: 'pushPayloadJson',
        type: 'json',
        default: '{"appId":"","title":"","body":"","deviceIds":[]}',
        displayOptions: { show: { resource: ['pushMessages'], operation: ['send'] } },
      },
      { displayName: 'Push Message ID', name: 'pushMessageId', type: 'string', default: '', displayOptions: { show: { resource: ['pushMessages'], operation: ['get', 'cancel'] } } },
      ...
      {
        displayName: 'Wait for Final Status',
        name: 'waitForStatus',
        type: 'boolean',
        default: false,
        description: 'Whether to poll until a final status is reached',
        displayOptions: {
          show: {
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether to confirm cancel/delete operations',
        displayOptions: {
          show: {
    ...
    for (let i = 0; i < items.length; i += 1) {
      try {
        ...
        if (resource === 'whatsapp') {
          ...
          if (operation === 'list') {
          ...
          } else if (operation === 'addParticipants' || operation === 'removeParticipants') {
            ...
            const to = toStringArray(this.getNodeParameter('to', i) as string);
            const description = this.getNodeParameter('inviteDescription', i, 'Group invite') as string;
          ...
          if (operation === 'list') {
            response = await apiRequest('GET', '/email/domains');
          } else if (operation === 'create') {
